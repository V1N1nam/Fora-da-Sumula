...
# Os travessoes nas frases abaixo (e no rotulo "CONFRONTO — QUEM
# GANHARIA") sao copia literal de fora-da-sumula-export.html. O commit
# que tirou travessao do texto visivel mexeu no site (docs/index.html e
# fora-da-sumula-v3.html) e nao no gerador de imagens, que continua com
# eles. Enquanto for assim, estas frases acompanham o template: card em
# Python e card em SVG dizendo a mesma coisa com pontuacao diferente e
# divergencia silenciosa. Se for limpar, limpar os dois no mesmo commit.
DISCLAIMERS = [
